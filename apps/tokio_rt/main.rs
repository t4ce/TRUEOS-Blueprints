...
async fn run_probe() -> Result<(), &'static str> {
    ...
    logl::log(level::INFO, format_args!("tokio_rt: stage rt.select"));
    ...
    logl::log(level::INFO, format_args!("tokio_rt: success rt.select"));
...
async fn probe_sync() -> Result<(), &'static str> {
    logl::log(level::INFO, format_args!("tokio_rt: stage sync.oneshot"));
    ...
    logl::log(level::INFO, format_args!("tokio_rt: success sync.oneshot"));

    logl::log(level::INFO, format_args!("tokio_rt: stage sync.mpsc"));
    ...
    logl::log(level::INFO, format_args!("tokio_rt: success sync.mpsc"));

    logl::log(level::INFO, format_args!("tokio_rt: stage sync.watch"));
    ...
    logl::log(level::INFO, format_args!("tokio_rt: success sync.watch"));

    logl::log(level::INFO, format_args!("tokio_rt: stage sync.broadcast"));
    ...
    logl::log(level::INFO, format_args!("tokio_rt: success sync.notify"));

    logl::log(level::INFO, format_args!("tokio_rt: stage sync.mutex"));
    ...
    logl::log(level::INFO, format_args!("tokio_rt: success sync.mutex"));

    logl::log(level::INFO, format_args!("tokio_rt: stage sync.rwlock"));
    ...
    logl::log(level::INFO, format_args!("tokio_rt: success sync.rwlock"));

    logl::log(level::INFO, format_args!("tokio_rt: stage sync.semaphore"));
    ...
    logl::log(level::INFO, format_args!("tokio_rt: success sync.barrier"));
...
async fn probe_time() -> Result<(), &'static str> {
    ...
    logl::log(level::INFO, format_args!("tokio_rt: stage time.interval"));
    let mut interval = t::time::interval(t::time::Duration::from_millis(1));
    interval.tick().await;
    interval.tick().await;
    logl::log(level::INFO, format_args!("tokio_rt: success time.interval"));
...
async fn probe_io() -> Result<(), &'static str> {
    ...
    logl::log(level::INFO, format_args!("tokio_rt: stage io.duplex"));
    ...
    logl::log(level::INFO, format_args!("tokio_rt: success io.duplex"));

    logl::log(level::INFO, format_args!("tokio_rt: stage io.std.surface"));
