...
const INDEX_HTML: &str = include_str!("system_services/index.html");
const TAILWIND_CSS: &str = include_str!("system_services/tailwind.css");
...
/// Serve the SystemServices UI from the shared FileSystem Blueprint process.
///
/// The listener stays on its established port, independently of the file
/// browser and WebDevices listeners.
