...
impl ProviderOp {
    ...
    pub const fn stack_cleanup_bytes(self) -> u8 {
        match self {
            ...
            Self::WsaStartup => 8,
            Self::CreateIoCompletionPort => 16,
...
pub fn provider_op(import: &ProviderImport) -> ProviderOp {
    ...
    if import.module.eq_ignore_ascii_case("KERNEL32.dll") {
        return match symbol.as_str() {
            ...
            "GetQueuedCompletionStatus" => ProviderOp::GetQueuedCompletionStatus,
    ...
    if import.module.eq_ignore_ascii_case("USER32.dll") {
        return match symbol.as_str() {
            ...
            "GetMessageA" => ProviderOp::GetMessageA,
            "TranslateMessage" => ProviderOp::TranslateMessage,
            "DispatchMessageA" => ProviderOp::DispatchMessageA,
            _ => ProviderOp::Unknown,
        };
    }
