...
pub use trueos::{TrueosDisplayHandle, TrueosWindowHandle};
...
pub enum RawWindowHandle {
    ...
    /// A raw window handle for the TRUEOS UI4 service.
    Trueos(TrueosWindowHandle),
...
pub enum RawDisplayHandle {
    ...
    /// A raw display handle for the TRUEOS UI4 service.
    Trueos(TrueosDisplayHandle),
...
from_impl!(RawDisplayHandle, Trueos, TrueosDisplayHandle);
...
from_impl!(RawWindowHandle, Trueos, TrueosWindowHandle);
