...
pub const HYPER_ITER_CONTINUE: core::ffi::c_int = 0;
/// Return in iter functions to stop iterating.
#[allow(unused)]
pub const HYPER_ITER_BREAK: core::ffi::c_int = 1;

/// An HTTP Version that is unspecified.
pub const HYPER_HTTP_VERSION_NONE: core::ffi::c_int = 0;
/// The HTTP/1.0 version.
pub const HYPER_HTTP_VERSION_1_0: core::ffi::c_int = 10;
/// The HTTP/1.1 version.
pub const HYPER_HTTP_VERSION_1_1: core::ffi::c_int = 11;
/// The HTTP/2 version.
pub const HYPER_HTTP_VERSION_2: core::ffi::c_int = 20;

#[derive(Clone)]
struct UserDataPointer(*mut core::ffi::c_void);
...
ffi_fn! {
    ...
    fn hyper_version() -> *const core::ffi::c_char {
